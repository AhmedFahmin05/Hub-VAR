...
//            mapper_file = argv[4];
        ...
        ofstream outfile;
        string file_path = "./dataset/TEST/AUS-road-d.MEL.gr";
        outfile.open(file_path, ios::out);

//        ofstream outfile1;
//        string file_path_1 = "./dataset/MEL/MEL_dis.txt";
//        outfile1.open(file_path_1, ios::out);
        ...
        for (unsigned i = 0; i < E; i++) {
            ...
            outfile << "a " << x + 1 << " " << y + 1 << " "  << v <<  endl;
            outfile << "a " << y + 1 << " " << x + 1 << " "  << v <<  endl;
            //outfile1 << x  << " " << y  << " "  << v <<  endl;
        }
        gr.close();
        outfile.close();
